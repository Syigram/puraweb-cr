...
const Typewriter = memo(({ words }) => {
  ...
  return (
    <span>
      {text}
      <span className="border-r-2 border-red-600 ml-1 inline-block">&nbsp;</span>
    </span>
  );
});
...
const Hero = memo(function Hero({ onGetStarted }) {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-red-50">
      {/* Static background - no animation for FCP */}
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-32 md:py-40">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            {/* Static stats - no animation for faster render */}
          ...
          {/* Simplified hero visual - no heavy animations */}
