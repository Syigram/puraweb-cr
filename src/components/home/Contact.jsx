...
const Contact = memo(function Contact({ transparent = false, showContactTitle = true }) {
  ...
  return (
    <section id="contact" className={`py-4 sm:py-8 ${transparent ? 'bg-transparent' : 'bg-gradient-to-b from-gray-50 to-white'}`}>
          ...
          >
            <Card className="border-0 shadow-xl [transform:none]">
              <CardContent className="p-4 sm:p-8">
                ...
                <form ref={nativeFormRef} onSubmit={handleSubmit} className="space-y-5">
