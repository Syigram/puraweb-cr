...
const ICONS = [
  ...
  { id: "mapradar", label: "Pin Radar",            emoji: "🎯" },
  { id: "mapglobe", label: "Pin + Globo",          emoji: "🌍" },
  { id: "mapcluster", label: "Pin Cluster",        emoji: "🗺️" },
  { id: "maproute", label: "Pin Ruta",             emoji: "🛣️" },
  { id: "mapsignal", label: "Pin Señal WiFi",      emoji: "📶" },
