  ...
  es: {
    ...
    footer: {
      ...
      checkout: {
        ...
        projectNamePlaceholder: "Ej: Mi Tienda Online, Web Restaurante...",
        projectNameHint: "Un nombre para identificar este proyecto en tu panel",
    ...
    footer: {
      ...
      checkout: {
            ...
            projectNamePlaceholder: "E.g: My Online Store, Restaurant Website...",
            projectNameHint: "A name to identify this project in your dashboard",
