export const translations = {
  es: {
    ...
    services: {
      ...
      ecommerce: {
        ...
        description: "Tiendas en línea poderosas con pasarelas de pago seguras, gestión de inventario y checkout sin problemas."
      },
      mobile: {
        title: "Diseño Mobile-First",
        description: "Interfaces hermosas que funcionan perfectamente en todos los dispositivos y tamaños de pantalla."
      },
      performance: {
    ...
    contact: {
      ...
      form: {
        ...
        sending: "Enviando...",
        send: "Enviar Mensaje",
        successMessage: "¡Gracias! Nos pondremos en contacto dentro de 24 horas.",
        errorMessage: "Error al enviar el mensaje. Por favor intente de nuevo."
      },
      info: {
        email: "Correo",
        phone: "Teléfono",
    ...
    footer: {
      description: "Creando experiencias digitales excepcionales para empresas en Costa Rica y más allá.",
      servicesTitle: "Servicios",
      webDev: "Desarrollo Web",
      ecommerce: "Soluciones E-Commerce",
      customApps: "Apps Web Personalizadas",
    ...
    checkout: {
      ...
      onetimeMode: "Adelanto del 50%",
      subscriptionDescription: "Acceso completo inmediato. Facturación recurrente automática cada mes.",
      onetimeDescription: "Adelanto del 50% de la primera mensualidad para iniciar el desarrollo. El restante 50% se abona contra entrega.",
      subtotal: "Subtotal",
      taxes: "Impuestos",
  ...
  en: {
    ...
    footer: {
      description: "Crafting exceptional digital experiences for businesses in Costa Rica and beyond.",
      servicesTitle: "Services",
      webDev: "Web Development",
      ecommerce: "E-Commerce Solutions",
      customApps: "Custom Web Apps",
    ...
    checkout: {
      ...
      onetimeMode: "50% Upfront Deposit",
      subscriptionDescription: "Immediate full access. Automatic recurring billing every month.",
      onetimeDescription: "50% deposit of the first monthly fee to start development. The remaining 50% is paid upon delivery.",
      subtotal: "Subtotal",
      taxes: "Taxes",
