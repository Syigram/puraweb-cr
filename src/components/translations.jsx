  ...
  es: {
    ...
    footer: {
      ...
      checkout: {
        ...
        projectNamePlaceholder: "Ej: Sitio Web Corporativo, Tienda Online, etc.",
        projectNameHelper: "Te ayudará a identificar este servicio en tu panel",
    ...
    footer: {
      ...
      checkout: {
        ...
        projectNamePlaceholder: "E.g: Corporate Website, Online Store, etc.",
        projectNameHelper: "Helps you identify this service in your dashboard",
