...
const portfolioProjects = [
  ...
  },
  {
    ...
    fullDescription: {
      es: "Desarrollamos una solución digital completa para la Clínica Dental del Dr. Rodríguez, incluyendo un sistema de citas online que reduce el trabajo administrativo en un 60%. El portal de pacientes permite acceder a historiales médicos, resultados de exámenes y recordatorios automáticos de citas.",
      en: "We developed a complete digital solution for Dr. Rodríguez Dental Clinic, including an online appointment system that reduces administrative work by 60%. The patient portal allows access to medical records, exam results, and automatic appointment reminders."
    },
  ...
  },
  {
    ...
    fullDescription: {
      es: "Aventuras Pura Vida es una plataforma de turismo que conecta a viajeros con experiencias auténticas en Costa Rica. Desarrollamos un sistema completo de reservas de tours en tiempo real, galería inmersiva con fotos y videos 360°, calendario de disponibilidad dinámico, y sección de testimonios verificados.",
      en: "Aventuras Pura Vida is a tourism platform that connects travelers with authentic experiences in Costa Rica. We developed a complete real-time tour booking system, immersive gallery with 360° photos and videos, dynamic availability calendar, and verified testimonials section."
    },
  ...
  },
  {
    ...
    fullDescription: {
      es: "Fitness Pro Gym transformó su operación con nuestra plataforma digital integral. Los miembros pueden comprar y gestionar membresías online, reservar clases grupales, hacer seguimiento de su progreso con gráficas personalizadas, y recibir planes de entrenamiento personalizados.",
      en: "Fitness Pro Gym transformed its operation with our comprehensive digital platform. Members can purchase and manage memberships online, book group classes, track their progress with personalized graphs, and receive customized training plans."
    },
...
function PortfolioListItem({ project, language }) {
  return (
    <motion.div
      variants={fadeInUp}
          ...
          {project.demoUrl && (
            <div>
              <Button
                ...
                className="bg-gradient-to-r from-blue-900 to-blue-700 hover:from-blue-800 hover:to-blue-600 text-white gap-2"
              >
                <ExternalLink className="w-4 h-4" />
                {language === "es" ? "Ver Sitio Web" : "View Website"}
              </Button>
            </div>
          )}
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-sm text-blue-600 mt-2 font-medium">
              {language === "es" ? "Versión: Vista de Lista Detallada" : "Version: Detailed List View"}
            </p>
          </motion.div>
        </div>
      </section>
