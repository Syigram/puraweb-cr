...
import { ExternalLink, Eye, Tag, Calendar, ArrowRight, X } from "lucide-react";
...
const portfolioProjects = [
  ...
  },
  {
    ...
    fullDescription: {
      es: "Fitness Pro Gym transformó su operación con nuestra plataforma digital integral. Los miembros pueden comprar y gestionar membresías online, reservar clases grupales, hacer seguimiento de su progreso con gráficas personalizadas, y recibir planes de entrenamiento personalizados. Implementamos un sistema de check-in con código QR, notificaciones automáticas de clases, y portal del entrenador para gestión de clientes. La retención de miembros mejoró un 35% y las inscripciones online crecieron un 80%.",
      en: "Fitness Pro Gym transformed its operation with our comprehensive digital platform. Members can purchase and manage memberships online, book group classes, track their progress with personalized graphs, and receive customized training plans. We implemented a QR code check-in system, automatic class notifications, and trainer portal for client management. Member retention improved by 35% and online registrations grew by 80%."
    },
...
function PortfolioCard({ project, language, onOpenModal }) {
...
function ProjectModal({ project, isOpen, onClose, language }) {
          ...
          {project.demoUrl && (
            <div className="pt-4 border-t">
              <Button
                ...
                className="w-full bg-gradient-to-r from-blue-900 to-blue-700 hover:from-blue-800 hover:to-blue-600 text-white gap-2"
              >
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-sm text-blue-600 mt-2 font-medium">
              {language === "es" ? "Versión: Modal con Detalles" : "Version: Modal with Details"}
            </p>
          </motion.div>
        </div>
      </section>
