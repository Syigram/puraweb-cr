    ...
    <>
      ...
      <div className="pb-8 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto mb-4 flex items-center gap-2 justify-center">
          ...
          >
            {/* VARIANTE A — Banner cinematográfico */}
            {activeVariant === "A" && (
            ...
            {/* VARIANTE B — Card oscura con íconos */}
            {activeVariant === "B" && (
