          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                {language === 'es' 
                  ? 'Mi nombre es Alejandro González, fundador y líder técnico de este equipo. Graduado de Ingeniería en Computadores en el TEC y con más de 10 años en la industria. Mi compromiso es garantizar la seguridad de sus datos y la estabilidad digital de su negocio. Con nosotros, su infraestructura digital está en manos expertas, permitiéndole a usted enfocarse en su empresa.'
