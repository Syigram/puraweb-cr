...
const translations = {
  es: {
    title: "Mi Cuenta",
    subtitle: "Gestiona tu perfil, suscripción y transacciones.",
    tabs: {
      profile: "Perfil",
  ...
  en: {
    title: "My Account",
    subtitle: "Manage your profile, subscription and transactions.",
    tabs: {
      profile: "Profile",
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs defaultValue="profile" className="space-y-6">
          ...
          <TabsContent value="subscription">
            <UserSubscription userEmail={user.email} />
          </TabsContent>
